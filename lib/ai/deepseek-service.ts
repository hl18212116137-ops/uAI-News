...
${content}`;
  ...
  async summarizeLongform(input: LongformDigestInput): Promise<LongformDigestDraft> {
    try {
      ...
      console.error('DeepSeek summarizeLongform error:', error);
      throw error;
    }
  }
...
评分参考：重大模型/产品发布 85-100，技术突破 80-95，重要融资 75-90，高价值观点/线索 60-78，一般更新 40-70，低信息量 0-39。观点线索若只是情绪或泛泛评论，应低于 40。
请只返回一个整数，不要其他文字。`;
