  ...
  return (
    <div className="w-[144px] flex-shrink-0">
      ...
      <div className="flex flex-col gap-3">
        {categoryLabel && (
          <div
            className="h-[32px] flex items-center justify-between px-3 py-0 text-[14px] font-normal leading-[20px] text-[#4a5565] hover:text-[#101828] transition-colors rounded hover:bg-[#f9fafb]"
